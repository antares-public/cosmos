...
function init() {
  ...
  var arc = Math.PI * 3;
  var geometry3 = new THREE.TorusGeometry(
    radius,
    tubeRadius,
    radialSegments,
    tubularSegments,
      ...
      case "IcosahedronGeometry":
        if (currentcolor == 0xf66120) {
          if (planetViewed == 0) {
            ...
            description.innerHTML =
              "Alive for <span>204895</span> years<br/><br/><div>Click on the other planets to learn more ...<div>";
          }
        ...
        if (currentcolor == 0x26d7e7) {
          if (planetViewed == 1 || planetViewed == 3 || planetViewed == 4) {
            ...
            description.innerHTML =
              "<br/><br/><div>Click on the other planets to learn more ...<div>";
